...
class _AddMedicineState extends State<AddMedicine> {
  ...
  Future<List<MedicinesTableData>> getMedicineList() async {
    return await widget._database.getAllMedicines();
  }

  late List<MedicinesTableData> medindex;
  ...
  void _submit(NotificationManager manager) async {
    if (_formKey.currentState!.validate()) {
      ...
      showTimePicker(
        ...
        // var medicineId = MedicinesTableCompanion.insert(  name: _name,
        //     dose: _dose,
        //     image: 'images/' + _icons[_selectedIndex]);
        var medicineId = await widget._database.insertMedicine(
         MedicinesTableCompanion.insert(  name: _name,
             dose: _dose,
             image: 'images/' + _icons[_selectedIndex]));
            // MedicinesTableData(
            //     id : ,
        ...
        medindex = await getMedicineList();
        MedicinesTableData meddindex = medindex.last;

        print("Meow");
        print(meddindex);
        manager.showNotificationDaily(meddindex.id, _name, _dose, hour, minute);
  ...
  Widget _buildIcons(int index) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Image.asset('images/' + _icons[index]),
      ),
    );
  }
}
